...
public class HengGameLevelTwo extends AbstractGame{
    ...
    private static final String INTRO_SPLASH_FILE = "assets/day_one_finished.png";        
    private static final String LOSE_SCREEN = "assets/lose_screen.png";
    private static final String BACKGROUND_TWO = "assets/background_two.png";
    ...
    protected void updateGame(){
        ...
        setTitleText("~ DAY TWO ~ HP: " + player.getHP() + ", Points: " + score);
    ...
    protected void spawnEntities()
    {
        ...
        for (int i = 0; i<numSpawn; i++) // spawning entities based on numSpawn
        {
			...
			if (type < 2)
			{
				newSpawn = new RareGet(DEFAULT_WIDTH, rand.nextInt(DEFAULT_HEIGHT-150)+100);
			}
		   
			else if (type < 7)
			{
				newSpawn = new Get(DEFAULT_WIDTH, rand.nextInt(DEFAULT_HEIGHT-150)+100);
			}
			else // if (type >=7)
			{
				newSpawn = new Avoid(DEFAULT_WIDTH, rand.nextInt(DEFAULT_HEIGHT-210)+100);
				((Avoid)newSpawn).setScrollSpeed(7);
			}
		   
			while (checkCollision(newSpawn) != null)
			{
				newSpawn.setY(rand.nextInt(DEFAULT_HEIGHT-(newSpawn.getHeight()+100)+100));
			}
    ...
    protected void postGame(){
        ...
        {
        	AbstractGame gamePartThree = new HengGameLevelThree();
        	gamePartThree.play();
        }
    }
