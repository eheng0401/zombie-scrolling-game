...
public class HengGameLevelOne extends AbstractGame{
    ...
    private static final String INTRO_SPLASH_FILE = "assets/start_image.png";        
    private static final String LOSE_SCREEN = "assets/lose_screen.png";
    private static final String BACKGROUND_ONE = "assets/background_one.png";
    ...
    protected void updateGame(){
        ...
        setTitleText("~ DAY ONE ~ HP: " + player.getHP() + ", Points: " + score);
    ...
    protected void postGame(){
        ...
        {
        	AbstractGame gamePartTwo = new HengGameLevelTwo();
        	gamePartTwo.play();
        } 
    }
